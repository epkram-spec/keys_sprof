      ...
      <section className="rounded-lg border bg-card p-4 shadow-sm md:p-5">
        <div className="mb-4 flex flex-col gap-3 border-b pb-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Спочатку назва, суть, сегмент і місто. Цього достатньо, щоб кейс не загубився.</p>
          </div>
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <SelectField label="Сегмент" name="segmentId" value={caseItem?.segment_id ?? ""}>
            ...
            <SelectField label="Місто" name="cityId" value={caseItem?.city_id ?? ""}>
              <option value="">Не вибрано</option>
              {cities.map((city) => (
            ...
            <SelectField label="Статус" name="projectStatus" value={caseItem?.project_status ?? "Новий"}>
